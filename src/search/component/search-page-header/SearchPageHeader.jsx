...
export class SearchPageHeader extends Component {
  ...
  render() {
    const animateHeader = (!this.props.isHomePage && this.props.animateHeaderAtSearch);
    ...
    return (
      <div className="search-page-header"
           style={(this.props.isHomePage) ? homeBackgroundStyle : searchBackgroundStyle}>
        <div className={(!this.props.isHomePage && "search-page-header-content-background")}>
          <div className="search-page-header-content-container">
            <div className={(this.props.isHomePage) ? "search-page-header-home-logo-container" : "search-page-header-logo-container"}>
              <Link to="/">
                <img className={(this.props.isHomePage) ? "search-page-header-home-logo" : "search-page-header-logo"}
